...
- (void)viewDidLoad {
    ...
    NSString *queryFeed = [NSString stringWithFormat:@"%@/iosStreamv2/English/EnglishConfig.xml",domain];
    NSString *Dir = [appDelegate.applicationDocumentsDirectory stringByAppendingPathComponent:@"EnglishConfig.xml"];
...
-(void)ConfigureProductList:(NSString *)ProductID{
    ...
    NSString* OneWeek = @"English1week";    //[ProductID stringByAppendingString:@"1week"]; // fixing a naming problem here i made a misake on itunes
...
- (void)reviewPressed {
    ...
    NSString *str = @"https://userpub.itunes.apple.com/WebObjects/MZUserPublishing.woa/wa/addUserReview?id=533079978&type=Purple+Software"; 
